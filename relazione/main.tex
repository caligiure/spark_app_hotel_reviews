...
\begin{itemize}
    ...
    \item \textbf{Streaming}: integrare Spark Structured Streaming per elaborare recensioni in tempo reale.
    \item \textbf{Raccomandation System}: sviluppare un sistema di raccomandazione basato sulla similarità utente-utente .
\end{itemize}
